...
subscriptionRouter.post('/subscribe', validateBody(SubscribeDto), async (req: Request, res: Response) => {
...
subscriptionRouter.get('/subscriptions', validateQuery(GetSubscriptionsDto), async (req: Request, res: Response) => {
